...
export function NotFound() {
  ...
  return (
    <div className="min-h-svh flex flex-col items-center justify-center px-6" style={{ background: "#f7f5f0", fontFamily: "var(--font-body)" }}>
      ...
      <button onClick={() => navigate("/dashboard")} className="flex items-center gap-2 px-6 py-3 rounded-full font-medium transition-colors hover:opacity-90" style={{ background: "#1a2e1c", color: "#f7f5f0", fontSize: "0.875rem" }}>
